...
| Verschieben | Knoten ziehen — mit Hauptknoten wandert der ganze Ast starr mit (umschaltbar über das Ketten-Symbol in der Kopfzeile); `Alt` gedrückt halten kehrt das jeweilige Verhalten um |
